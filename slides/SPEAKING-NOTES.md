...
each feature is a **docs commit then a feat commit** - the writing and the code kept separate.
...
in `research.md`. Two concrete stories:
...
- 3 features under `specs/`: `001-als-map-explorer`, `002-contours-learning-depth`,
  `003-request-preview-doc-links`. All committed.
- Task counts: **001 = 38, 002 = 18, 003 = 14.**
...
- Stack: maplibre-gl ^5.24, CodeMirror 6, Web Awesome ^3.10, Vite 6, Vitest 3 -
  no AWS SDK.
- Commit rhythm: `docs:` then `feat:` per feature (see `git log`).
